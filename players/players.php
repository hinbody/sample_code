<?php
require_once '../whoami.php'; //database credentials
...
//check the value of crudFunction selected from form 
if ($_POST['crudFunction'] == 'create')
{
  //assign values from sanitized input
...
//loop through db query to print players
for ($i = 0; $i < $numRows; ++$i)
{
